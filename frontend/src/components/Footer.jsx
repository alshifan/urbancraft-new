            ...
            <ul className="space-y-3 text-gray-600">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="flex flex-nowrap items-center gap-2 whitespace-nowrap">
                  <a href="tel:+12269893966" className="text-sm hover:underline whitespace-nowrap">+1 (226) 989-3966</a>
                  <span className="text-gray-400">|</span>
                  <a href="tel:+15799851427" className="text-sm hover:underline whitespace-nowrap">+1 (579) 985-1427</a>
                  <span className="text-gray-400">|</span>
                  <a href="tel:+919940914399" className="text-sm hover:underline whitespace-nowrap">+91 9940914399</a>
                </span>
              </li>
              <li className="flex items-center gap-2">
                {/* Mail Icon */}
