...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_5zw6tls", // 🔁 Replace with your EmailJS Service ID
        "template_ovv70j5", // 🔁 Replace with your EmailJS Template ID
        formData,
        "du391qljWg8WbqgL0"  // 🔁 Replace with your EmailJS Public Key
      )
      .then(
        () => {
